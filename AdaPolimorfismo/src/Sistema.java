...
public class Sistema {
    ...
    public static void main(String[] args) {
        ...
        double ventas,salario,comision,bono=0;
                ...
                if (empleados.isEmpty()) {
                    ...
                    for (Empleado empleado : empleados) {
                        if (empleado instanceof EmpleadoBaseMasComision){
                            System.out.println("INGRESE LA CANTIDAD DE BONO QUE QUIERE ASIGNARLE A: "+empleado.getNombre()+" "+empleado.getApellidoP()+" ESTE MES");
                            System.out.println("10% -> .10  20% -> .20  30% -> .30");
                            bono=numScanner.nextDouble();
                            ((EmpleadoBaseMasComision) empleado).setSalarioBase(((EmpleadoBaseMasComision) empleado).getSalarioBase()*(1+bono));
                        }
